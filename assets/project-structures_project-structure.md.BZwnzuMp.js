import{_ as n,o as a,c as e,ag as p}from"./chunks/framework.CtWPcAmt.js";const m=JSON.parse('{"title":"Project Structure","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"project-structures/project-structure.md","filePath":"en/project-structures/project-structure.md","lastUpdated":1788757228000}'),i={name:"project-structures/project-structure.md"};function l(t,s,o,c,r,u){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="project-structure" tabindex="-1">Project Structure <a class="header-anchor" href="#project-structure" aria-label="Permalink to &quot;Project Structure&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>│  │  │  └─ config.js - \`electron-builder\` dynamic configuration file</span></span>
...
<span class="line"><span>├─ src/</span></span>
<span class="line"><span>│  ├─ common/ - Code shared by the main and renderer processes</span></span>
<span class="line"><span>│  │  └─ ipc.ts - IPC channel names and payload types</span></span>
<span class="line"><span>│  │  └─ locales.ts - Supported languages and language tag matching</span></span>
...
<span class="line"><span>│  │  │  └─ devTools.ts - When DevTools opens in a development build</span></span>
<span class="line"><span>│  │  │  └─ ipc.ts - IPC registration helpers typed against the channel contracts</span></span>
<span class="line"><span>│  │  │  └─ security.ts - Navigation and external link guards</span></span>
<span class="line"><span>│  │  └─ index.ts - Main process entry point</span></span>
<span class="line"><span>│  │  └─ index.dev.ts - Development-only setup, stripped from packaged builds</span></span>
...
<span class="line"><span>│  │  └─ tray.ts - Tray icon and tray window handling</span></span>
<span class="line"><span>│  │  └─ WindowManager.ts - Windows opened on top of the main window</span></span>
...
<span class="line"><span>│  ├─ mainApi.d.ts - Type of the \`window.mainApi\` bridge exposed by the preload</span></span>
<span class="line"><span>│  └─ vue-shim.d.ts - Type declaration for \`*.vue\` imports</span></span>
...
<span class="line"><span>│  ├─ fixtures.mts - Test common execution API</span></span>
<span class="line"><span>│  └─ testUtil.mts - Test utilities</span></span>
...
<span class="line"><span>├─ .nvmrc - Node.js version used for development</span></span>
...
<span class="line"><span>├─ CONTRIBUTING.md - Contribution guide, used only on GitHub</span></span>
...
<span class="line"><span>├─ SECURITY.md - Security policy, used only on GitHub</span></span>
<span class="line"><span>├─ tsconfig.json - TypeScript configurations (renderer, common)</span></span>
<span class="line"><span>├─ tsconfig.node.json - TypeScript configurations (main, preload, common, tests)</span></span>
<span class="line"><span>├─ vite.config.mts - Vite compiler build configurations</span></span>
<span class="line"><span>└─ README.md - Files used only on GitHub</span></span></code></pre></div>`,2)])])}const g=n(i,[["render",l]]);export{m as __pageData,g as default};
