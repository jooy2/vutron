import{_ as n,o as a,c as p,ag as e}from"./chunks/framework.CtWPcAmt.js";const m=JSON.parse('{"title":"프로젝트 구조","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"ko/project-structures/project-structure.md","filePath":"ko/project-structures/project-structure.md","lastUpdated":1788757228000}'),l={name:"ko/project-structures/project-structure.md"};function i(c,s,t,r,o,u){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="프로젝트-구조" tabindex="-1">프로젝트 구조 <a class="header-anchor" href="#프로젝트-구조" aria-label="Permalink to &quot;프로젝트 구조&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>│  │  │  └─ config.js - \`electron-builder\` 동적 구성 파일</span></span>
...
<span class="line"><span>├─ src/</span></span>
<span class="line"><span>│  ├─ common/ - 메인과 렌더러 프로세스가 함께 사용하는 코드</span></span>
<span class="line"><span>│  │  └─ ipc.ts - IPC 채널 이름과 주고받는 데이터의 타입</span></span>
<span class="line"><span>│  │  └─ locales.ts - 지원 언어 목록과 언어 태그 매칭</span></span>
...
<span class="line"><span>│  │  │  └─ devTools.ts - 개발 환경에서 DevTools를 여는 시점 처리</span></span>
<span class="line"><span>│  │  │  └─ ipc.ts - 채널 계약이 적용된 IPC 등록 도우미</span></span>
<span class="line"><span>│  │  │  └─ security.ts - 네비게이션 및 외부 링크 가드</span></span>
<span class="line"><span>│  │  └─ index.ts - 메인 프로세스 진입점</span></span>
<span class="line"><span>│  │  └─ index.dev.ts - 개발 환경 전용 설정, 패키징 빌드에서는 제외됨</span></span>
...
<span class="line"><span>│  │  └─ tray.ts - 트레이 아이콘 및 트레이 윈도우 처리</span></span>
<span class="line"><span>│  │  └─ WindowManager.ts - 메인 윈도우 위로 열리는 창 관리</span></span>
...
<span class="line"><span>│  ├─ mainApi.d.ts - 프리로드가 노출하는 \`window.mainApi\` 브릿지의 타입</span></span>
<span class="line"><span>│  └─ vue-shim.d.ts - \`*.vue\` 임포트를 위한 타입 선언</span></span>
...
<span class="line"><span>│  ├─ fixtures.mts - 공통 실행 API 테스트</span></span>
<span class="line"><span>│  └─ testUtil.mts - 테스트 유틸리티</span></span>
...
<span class="line"><span>├─ .nvmrc - 개발에 사용하는 Node.js 버전</span></span>
...
<span class="line"><span>├─ CONTRIBUTING.md - 기여 가이드, GitHub에서만 사용되는 파일</span></span>
...
<span class="line"><span>├─ SECURITY.md - 보안 정책, GitHub에서만 사용되는 파일</span></span>
<span class="line"><span>├─ tsconfig.json - TypeScript 설정 (렌더러, 공통)</span></span>
<span class="line"><span>├─ tsconfig.node.json - TypeScript 설정 (메인, 프리로드, 공통, 테스트)</span></span>
<span class="line"><span>├─ vite.config.mts - Vite 컴파일러 빌드 설정</span></span>
<span class="line"><span>└─ README.md - GitHub에서만 사용되는 파일</span></span></code></pre></div>`,2)])])}const g=n(l,[["render",i]]);export{m as __pageData,g as default};
