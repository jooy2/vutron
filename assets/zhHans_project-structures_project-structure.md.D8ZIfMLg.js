import{_ as n,o as a,c as p,ag as e}from"./chunks/framework.CtWPcAmt.js";const m=JSON.parse('{"title":"项目结构","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"zhHans/project-structures/project-structure.md","filePath":"zhHans/project-structures/project-structure.md","lastUpdated":1788757228000}'),l={name:"zhHans/project-structures/project-structure.md"};function i(c,s,t,r,o,u){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="项目结构" tabindex="-1">项目结构 <a class="header-anchor" href="#项目结构" aria-label="Permalink to &quot;项目结构&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>│  │  │  └─ config.js - \`electron-builder\`动态配置文件</span></span>
...
<span class="line"><span>├─ src/</span></span>
<span class="line"><span>│  ├─ common/ - 主进程与渲染器进程共用的代码</span></span>
<span class="line"><span>│  │  └─ ipc.ts - IPC 通道名称与传输数据的类型</span></span>
<span class="line"><span>│  │  └─ locales.ts - 支持的语言列表与语言标签匹配</span></span>
...
<span class="line"><span>│  │  │  └─ devTools.ts - 开发环境下 DevTools 的打开时机</span></span>
<span class="line"><span>│  │  │  └─ ipc.ts - 按通道契约类型化的 IPC 注册辅助函数</span></span>
<span class="line"><span>│  │  │  └─ security.ts - 导航与外部链接防护</span></span>
<span class="line"><span>│  │  └─ index.ts - 主要流程入口</span></span>
<span class="line"><span>│  │  └─ index.dev.ts - 仅用于开发环境的配置，打包构建时会被排除</span></span>
<span class="line"><span>│  │  └─ IPCs.ts - 主要流程 ipc 处理程序定义</span></span>
<span class="line"><span>│  │  └─ MainRunner.ts - 主流程主窗口处理</span></span>
<span class="line"><span>│  │  └─ tray.ts - 托盘图标与托盘窗口处理</span></span>
<span class="line"><span>│  │  └─ WindowManager.ts - 主窗口之上打开的窗口管理</span></span>
...
<span class="line"><span>│  ├─ mainApi.d.ts - 预加载脚本暴露的 \`window.mainApi\` 桥接类型</span></span>
<span class="line"><span>│  └─ vue-shim.d.ts - \`*.vue\` 导入的类型声明</span></span>
...
<span class="line"><span>│  ├─ fixtures.mts - 测试公共执行API</span></span>
<span class="line"><span>│  └─ testUtil.mts - 测试实用程序</span></span>
<span class="line"><span>├─ .editorconfig - 编辑器推荐的IDE配置文件</span></span>
<span class="line"><span>├─ .gitignore - 不上传到Git的文件列表</span></span>
<span class="line"><span>├─ .nvmrc - 开发所使用的 Node.js 版本</span></span>
...
<span class="line"><span>├─ CONTRIBUTING.md - 贡献指南，仅在GitHub上使用的文件</span></span>
...
<span class="line"><span>├─ SECURITY.md - 安全策略，仅在GitHub上使用的文件</span></span>
<span class="line"><span>├─ tsconfig.json - TypeScript配置（渲染器、公共）</span></span>
<span class="line"><span>├─ tsconfig.node.json - TypeScript配置（主进程、预加载、公共、测试）</span></span>
