import{_ as n,c as a,a2 as p,o as e}from"./chunks/framework.DPuwY6B9.js";const g=JSON.parse('{"title":"프로젝트 구조","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"ko/project-structures/project-structure.md","filePath":"ko/project-structures/project-structure.md","lastUpdated":1725496835000}'),l={name:"ko/project-structures/project-structure.md"};function i(t,s,c,r,o,u){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="프로젝트-구조" tabindex="-1">프로젝트 구조 <a class="header-anchor" href="#프로젝트-구조" aria-label="Permalink to &quot;프로젝트 구조&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>│  │  ├─ public/ - Vue 정적 리소스</span></span>
...
<span class="line"><span>├─ .eslintrc.json - ESLint 규칙 구성</span></span>
