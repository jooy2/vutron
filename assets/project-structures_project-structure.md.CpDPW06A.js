import{_ as s,c as n,o as a,a4 as e}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"Project Structure","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"project-structures/project-structure.md","filePath":"project-structures/project-structure.md"}'),p={name:"project-structures/project-structure.md"},i=e(`<h1 id="project-structure" tabindex="-1">Project Structure <a class="header-anchor" href="#project-structure" aria-label="Permalink to &quot;Project Structure&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/</span></span>
...
<span class="line"><span>│  └─ app.spec.ts - Test file specification</span></span>
...
<span class="line"><span>├─ package.json - NodeJS package configurations</span></span>
...
<span class="line"><span>└─ README.md - Files used only on GitHub</span></span></code></pre></div>`,2),t=[i];function o(l,c,r,u,d,f){return a(),n("div",null,t)}const b=s(p,[["render",o]]);export{m as __pageData,b as default};
